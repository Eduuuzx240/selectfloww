...
def insert_sample_data(cursor):
    ...
    # Company profiles
    company_profiles = [
        (1, 'TechCorp Ltda', '12.345.678/0001-90', '(11) 3333-4444', 'Empresa de tecnologia focada em soluções inovadoras', 'Tecnologia', '50-100', 'https://techcorp.com', 'São Paulo, SP', 'https://linkedin.com/company/techcorp'),
        (6, 'InnovaTech', '98.765.432/0001-10', '(21) 2222-3333', 'Startup de tecnologia em crescimento', 'Tecnologia', '10-50', 'https://innovatech.com', 'Rio de Janeiro, RJ', 'https://linkedin.com/company/innovatech'),
    ]
    
    cursor.executemany("""
        INSERT INTO company_profiles (user_id, company_name, cnpj, company_phone, description, industry, size, website, location, linkedin)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, company_profiles)
    
    # Sample candidate profiles
    candidate_profiles = [
        (2, '123.456.789-01', '01234-567', '(11) 99999-0001', 'São Paulo, SP', 
         ...
         'https://joaosilva.dev'),
        (3, '987.654.321-02', '12345-678', '(11) 99999-0002', 'São Paulo, SP',
        ...
        (4, '456.789.123-03', '23456-789', '(21) 99999-0003', 'Rio de Janeiro, RJ',
        ...
        (5, '789.123.456-04', '34567-890', '(31) 99999-0004', 'Belo Horizonte, MG',
    ...
    cursor.executemany("""
        INSERT INTO candidate_profiles (user_id, cpf, cep, phone, location, skills, experience, education, languages, bio, linkedin, github, portfolio)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, candidate_profiles)
